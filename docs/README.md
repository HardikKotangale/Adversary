...
video), export it from the [Mermaid Live Editor](https://mermaid.live) by
pasting the code block from the README's Architecture section, then drop the
export here as `architecture.png` or `architecture.svg`.
